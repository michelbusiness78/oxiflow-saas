...
export function RapportPDF({ intervention, companyName = 'OxiFlow' }: RapportPDFProps) {
  ...
  return (
    <button
      ...
      onClick={generate}
      disabled={loading}
      className="flex w-full items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white shadow-sm py-4 text-sm font-semibold text-slate-800 hover:bg-white transition-colors disabled:opacity-60"
    >
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.75} stroke="currentColor" className="h-5 w-5 text-blue-600" aria-hidden>

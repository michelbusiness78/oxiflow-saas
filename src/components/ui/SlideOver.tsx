  ...
  return (
    <div className="fixed inset-0 z-40 flex justify-end" aria-modal="true" role="dialog">
      ...
      <div
        ref={panelRef}
        className={[
          'relative flex h-full w-full flex-col bg-white shadow-oxi-xl',
      ...
      >
        ...
        <div className="flex h-14 shrink-0 items-center justify-between border-b border-slate-200 px-5">
          ...
          <button
            onClick={onClose}
            className="flex h-8 w-8 items-center justify-center rounded-md text-slate-400 hover:bg-white hover:text-slate-800 transition-colors"
            aria-label="Fermer"
          >

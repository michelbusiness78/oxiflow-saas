  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1">
        ...
        {/* ─── TARIFS ──────────────────────────────────────────────────────── */}
        <section className="py-20 sm:py-24 bg-white" id="tarifs" aria-labelledby="pricing-title">
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            <div className="text-center max-w-2xl mx-auto mb-14 lp-animate">
              ...
              {[
                ...
                },
                {
                  ...
                  features: [
                    ...
                    'Tous les modules',
                    'Multi-sites',
                    '500 requêtes vocales / mois',
                    'Support téléphonique prioritaire',
                    'API & intégrations sur demande',
                  ],
                  delay: 'lp-animate-d3',
                },
              ].map((plan) => (
                ...
                >
                  ...
                  <div className="p-7 flex-1">
                    <h3 className="font-bold text-xl text-[#1B2A4A] mb-1">{plan.name}</h3>
                    <p className="text-sm text-slate-500 mb-5">{plan.desc}</p>
                    <div className="flex items-end gap-1 mb-6">
                      <span className="text-4xl font-extrabold text-[#1B2A4A]">{plan.price}€</span>
            ...
            <p className="text-center text-sm text-slate-500 mt-8 lp-animate">
              Tous les plans incluent 14 jours d&apos;essai gratuit · Sans carte bancaire · Annulation à tout moment
            </p>
          </div>
        </section>

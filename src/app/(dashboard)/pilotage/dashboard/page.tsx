    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-0.5 text-sm capitalize text-[var(--text2)]">{fmtDate()}</p>
        </div>
        <Suspense>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="lg:col-span-2">
          <Section title="Activité récente">
            <div className="rounded-[var(--radius)] border border-[var(--border)] bg-[var(--card)] shadow-[var(--shadow)] p-5">
        ...
        <div className="space-y-6">
          ...
          {isDashboardEmpty && (
            <Section title="Premiers pas">
              <div className="rounded-[var(--radius)] border border-[var(--border)] bg-[var(--card)] shadow-[var(--shadow)] p-5 space-y-3">
                <p className="text-sm text-[var(--text2)]">
                  Votre tableau de bord se remplira automatiquement avec votre activité.
                </p>
                <a
                  href="/commerce?tab=devis"
                  className="block w-full rounded-lg bg-[var(--blue)] px-4 py-2.5 text-center text-sm font-bold text-white hover:bg-[var(--blue2)] transition-colors"
                >
                  Créer votre premier devis
                </a>
                <a
                  href="/commerce?tab=clients"
                  className="block w-full rounded-lg border border-[var(--border)] px-4 py-2.5 text-center text-sm font-bold text-[var(--text2)] hover:bg-[var(--bg3)] transition-colors"
                >
                  Ajouter un client
                </a>
              </div>
